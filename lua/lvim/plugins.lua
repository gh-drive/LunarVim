...
local core_plugins = {
  { url = "https://cnb.cool/bennydou/vim/lazy.nvim.git", tag = "stable" },
  {
    url = "https://cnb.cool/bennydou/vim/nvim-lspconfig.git",
    lazy = true,
    dependencies = { "mason-lspconfig.nvim", "nlsp-settings.nvim" },
  },
  {
    url = "https://cnb.cool/bennydou/vim/mason-lspconfig.nvim.git",
  ...
  { url = "https://cnb.cool/bennydou/vim/nlsp-settings.nvim.git", cmd = "LspSettings", lazy = true },
  { url = "https://cnb.cool/bennydou/vim/none-ls.nvim.git", lazy = true },
  {
    url = "https://cnb.cool/bennydou/vim/mason.nvim.git",
  ...
  -- },
  {
    url = "https://cnb.cool/bennydou/vim/lunar.nvim.git",
    lazy = lvim.colorscheme ~= "lunar",
  },
  { url = "https://cnb.cool/bennydou/vim/structlog.nvim.git", lazy = true },
  { url = "https://cnb.cool/bennydou/vim/plenary.nvim.git", cmd = { "PlenaryBustedFile", "PlenaryBustedDirectory" }, lazy = true },
  -- Telescope
  {
    url = "https://cnb.cool/bennydou/vim/telescope.nvim.git",
    branch = "0.1.x",
  ...
  { url = "https://cnb.cool/bennydou/vim/telescope-fzf-native.nvim.git", build = "make", lazy = true, enabled = lvim.builtin.telescope.active },
  -- Install nvim-cmp, and buffer source as a dependency
  {
    url = "https://cnb.cool/bennydou/vim/nvim-cmp.git",
    config = function()
  ...
  { url = "https://cnb.cool/bennydou/vim/cmp-nvim-lsp.git", lazy = true },
  { url = "https://cnb.cool/bennydou/vim/cmp_luasnip.git", lazy = true },
  { url = "https://cnb.cool/bennydou/vim/cmp-buffer.git", lazy = true },
  { url = "https://cnb.cool/bennydou/vim/cmp-path.git", lazy = true },
  {
    url = "https://cnb.cool/bennydou/vim/cmp-cmdline.git",
    lazy = true,
  ...
  { url = "https://cnb.cool/bennydou/vim/friendly-snippets.git", lazy = true, cond = lvim.builtin.luasnip.sources.friendly_snippets },
  {
    url = "https://cnb.cool/bennydou/vim/neodev.nvim.git",
    lazy = true,
  },

  -- Autopairs
  {
    url = "https://cnb.cool/bennydou/vim/nvim-autopairs.git",
    event = "InsertEnter",
  ...
  -- Treesitter
  {
    url = "https://cnb.cool/bennydou/vim/nvim-treesitter.git",
    -- run = ":TSUpdate",
    config = function()
      local utils = require("lvim.utils")
  ...
  },
  {
    ...
    url = "https://cnb.cool/bennydou/vim/nvim-ts-context-commentstring.git",
    lazy = true,
  },
  ...
  -- },
  {
    url = "https://cnb.cool/bennydou/vim/gitsigns.nvim.git",
  ...
  -- Whichkey
  {
    url = "https://cnb.cool/bennydou/vim/which-key.nvim.git",
  ...
  -- Comments
  {
    url = "https://cnb.cool/bennydou/vim/Comment.nvim.git",
  ...
  -- Icons
  {
    url = "https://cnb.cool/bennydou/vim/nvim-web-devicons.git",
  ...
  -- Status Line and Bufferline
  {
    ...
    url = "https://cnb.cool/bennydou/vim/lualine.nvim.git",
  ...
  -- breadcrumbs
  {
    url = "https://cnb.cool/bennydou/vim/nvim-navic.git",
  ...
  {
    url = "https://cnb.cool/bennydou/vim/bufferline.nvim.git",
  ...
  -- alpha
  {
    url = "https://cnb.cool/bennydou/vim/alpha-nvim.git",
  ...
  -- Terminal
  {
    url = "https://cnb.cool/bennydou/vim/toggleterm.nvim.git",
    branch = "main",
  ...
  -- SchemaStore
  {
    url = "https://cnb.cool/bennydou/vim/schemastore.nvim.git",
    lazy = true,
  },

  {
    url = "https://cnb.cool/bennydou/vim/vim-illuminate.git",
  ...
  {
    url = "https://cnb.cool/bennydou/vim/indent-blankline.nvim.git",
  ...
  {
    url = "https://cnb.cool/bennydou/vim/bigfile.nvim.git",
    config = function()
